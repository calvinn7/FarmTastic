...
class DaysWidget extends StatelessWidget {
  ...
  Widget _pattern(BuildContext context, DayValues values) {
    Color bgColor = Colors.transparent; // Set default to transparent
    BoxBorder? border; // Set default to no border
    BorderRadius? borderRadius; // Set default to no border radius
    TextStyle txtStyle =
    ...
    if (values.isSelected) {
      if ((values.selectedMinDate != null &&
        ...
        // Round border for selected min and max dates
        borderRadius = BorderRadius.circular(10.0);
      } else if (values.isSelected &&
        ...
        // Round border for dates in between
        borderRadius = BorderRadius.circular(10.0);
      }
